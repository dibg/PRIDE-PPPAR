...
!! read arguments
  ...
  if (nargs .eq. 0) then
    write (*, '(a)') "                                                            "
    write (*, '(a)') "redig version 3.0, Wuhan University, Oct. 2024              "
    write (*, '(a)') "                                                            "
    write (*, '(a)') "Usage: redig resfile [options] <arguments>                  "
    write (*, '(a)') "                                                            "
    write (*, '(a)') "Description:                                                "
    write (*, '(a)') "  redig is a module of PRIDE PPP-AR, is used for cleaning   "
    write (*, '(a)') "  the observations according residuals file.                "
    write (*, '(a)') "                                                            "
    write (*, '(a)') "Required arguments:                                         "
    write (*, '(a)') "  resfile                                                   "
    write (*, '(a)') "    PRIDE PPP-AR's residuals file generated by lsq module.  "
    write (*, '(a)') "                                                            "
    write (*, '(a)') "Optional arguments:                                         "
    write (*, '(a)') "  -jmp [jump]                                               "
    write (*, '(a)') "    if the difference of phase residuals between adjacent   "
    write (*, '(a)') "    epochs is greater than jump, it is marked as a new      "
    write (*, '(a)') "    ambiguity. Default is 0, no special action. (Unit: mm)  "
    write (*, '(a)') "  -sht [short]                                              "
    write (*, '(a)') "    if the effective time of ambiguity is less than short,  "
    write (*, '(a)') "    the corresponding observation data will be deleted.     "
    write (*, '(a)') "    Default is 0, no special action. (Unit: second)         "
    write (*, '(a)') "  -pce                                                      "
    write (*, '(a)') "    quality control for satellite's data                    "
    write (*, '(a)') "                                                            "
    write (*, '(a)') "Note: Some dependent files need to be under folders.        "
    write (*, '(a)') "                                                            "
    write (*, '(a)') "Examples:                                                   "
    write (*, '(a)') "  redig res_2024001 -jmp 400 -sht 40                        "
    write (*, '(a)') "  redig res_2024001 -jmp 400 -sht 40 -pce                   "
    write (*, '(a)') "                                                            "
